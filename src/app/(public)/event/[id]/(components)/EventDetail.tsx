      ...
      {!isLoading ? (
        ...
        <div>
          <div className='w-full md:h-2/5'>
            ...
            ></Image>
            <div className='bg-white md:px-8 px-4 pb-10 pt-10 flex flex-col md:flex-row border-[1px] shadow'>
              ...
              <div className="mt-8 mb-8 w-full rounded-md bg-white border-[1px] shadow p-8">
                ...
                {EventDetail?.user?.loaiHinhKinhDoanh === "1" ? (
                  ...
                  <div className="mt-4 text-gray-600 text-[14px] flex flex-row">
                    ...
                    <div className='ml-4'>
                      <p className='text-lg font-bold'>{EventDetail?.user?.tenDoanhNghiep}</p>
                      <div className='mt-1 flex flex-row'>
                        <PhoneIcon size={18} />
                        <p className='ml-2'>{EventDetail?.user?.phoneNumber}</p>
                      </div>
            ...
            <div className='w-1/3 ml-10 h-[250px] sticky top-0 hidden md:block'>
              <div className="mt-8 mb-8 w-full rounded-md bg-white border-[1px] shadow p-8">
                <div className="flex flex-row justify-between flex-wrap">
                  ...
                  <div className='mt-10 w-full'> {/* Center button on mobile and push it to the right on larger screens */}
                    <Link href={`/ticket-booking/${EventDetail.id}`}>
                      <Button className='w-full font-bold bg-blue-700 hover:bg-amber-300 !box-border hover:text-black'>Đặt vé ngay</Button>
                    </Link>
                  </div>
                </div>
              </div>
