  ...
  return (
    <div className='w-full p-4 md:w-2/4 mr-0 md:mr-10'>
      <div className='h-auto min-h-[500px] bg-white border border-gray-200 shadow rounded-xl flex flex-col'>
        ...
        <RadioGroup className='p-4' description="Chọn hình thức thanh toán của bạn. Bạn sẽ được điều hướng đến trang thanh toán của đối tác cung cấp dịch vụ." value={paymentMethod} onValueChange={setPaymentMethod}>
