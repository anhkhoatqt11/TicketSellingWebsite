...
export const Sidebar = React.forwardRef<SidebarElement, Readonly<SidebarProps>>(
    ({ navItems, title, ...props }, forwardedRef) => {
        return (
            <aside
                ref={forwardedRef}
                className="px-6 flex flex-col gap-4 border-r border-slate-6 bg-white"
                {...props} >
                <div className="flex flex-row pl-4 pr-4 pb-4 pt-4 items-center justify-center">
                    <Logo />
                </div>
                                        ...
                                        {navItems.map((item) => {
                                            ...
                                            return (
                                                <Link
                                                    ...
                                                    className="flex items-center text-gray-900  hover:bg-blue-300 hover:text-white"
                                                >
                                                    <motion.span
