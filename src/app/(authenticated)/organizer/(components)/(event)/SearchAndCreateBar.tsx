  ...
  return (
    <div className="flex flex-col gap-2 md:flex-row md:justify-between mr-6 md:mr-0">
      <div className="flex flex-row">
        <Input
          className="h-[52px] w-full md:w-[270px]"
          variant="bordered"
          radius="sm"
      ...
      <Button
        className={`h-[50px] w-full md:w-[200px] rounded-md m-0 p-0 font-medium bg-[#3BE1AA] hover:bg-[#2DD196] text-sm text-black mr-6 md:mr-6`}
        onClick={() => {
